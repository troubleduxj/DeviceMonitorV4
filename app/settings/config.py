...
class AppsModels(BaseSettings):
    models: typing.List[str] = ["app.models.admin", "app.models.system", "app.models.device", "app.models.ai_monitoring", "app.models.audit_log", "app.models.alarm", "app.models.notification", "app.models.email", "aerich.models"]
