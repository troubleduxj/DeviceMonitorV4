...
async def create_device_field(
    ...
    try:
        ...
        # 创建字段数据
        field_create_data = field_data.model_dump()
        field_create_data["device_type_code"] = type_code
        
        # 创建字段
        field = await DeviceField.create(**field_create_data)
    ...
    try:
        ...
        if not realtime_data:
            ...
            result = {
                ...
                "vibration": realtime_data.vibration,
